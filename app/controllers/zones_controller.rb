class ZonesController < ApplicationController
  ...
  private
    ...
    def zone_params
      params.require(:zone).permit(:name, :abreviation, :identifier, :region_id)
    end

    #Array que contiene las opciones para seleccionar
    def set_regions
      #Creamos un array con todos los nombres de las regiones
      @regions = Array.new

      #Inicializamos nuestro array iterando las regiones para solo seleccionar el campo name
      Region.all.each do |r|
        @regions.push([r.name, r.id])
      end
    end
end
