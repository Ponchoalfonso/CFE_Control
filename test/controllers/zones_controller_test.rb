...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { abreviation: @zone.abreviation, identifier: @zone.identifier, name: @zone.name } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { abreviation: @zone.abreviation, identifier: @zone.identifier, name: @zone.name } }
