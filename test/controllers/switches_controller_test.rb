...
class SwitchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create switch" do
    assert_difference('Switch.count') do
      post switches_url, params: { switch: { lastupdate: @switch.lastupdate, name: @switch.name } }
    end
  ...
  test "should update switch" do
    patch switch_url(@switch), params: { switch: { lastupdate: @switch.lastupdate, name: @switch.name } }
